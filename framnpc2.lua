-- Script chạy vòng quanh mục tiêu gần nhất, có menu cơ bản cho KRNL Mobile
...
-- Tìm mục tiêu gần nhất (bất kỳ model nào có HumanoidRootPart)
...
-- Di chuyển vòng tròn quanh mục tiêu gần nhất

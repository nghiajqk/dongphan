...
local running, aiming, clicking, noclip, visible, bigHitbox = false, false, false, false, true, false
...
local toggleHitbox = createButton("Vùng Sát Thương To", 210)
...
toggleHitbox.MouseButton1Click:Connect(function()
	...
	toggleHitbox.Text = "Vùng Sát Thương To [" .. (bigHitbox and "ON" or "OFF") .. "]"
end)
	...
	while true do
		...
		if bigHitbox then
			...
			if tool then
				...
				if handle and handle ~= currentHandle then
